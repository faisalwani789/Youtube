...
const RecommendedCard = ({ info }) => {
  ...
  const url =  info?.snippet?.thumbnails?.medium.url
  if (!url) return null
  return (
      ...
      <div>
        ...
        <div className='flex '>
          ...
          <div className='pl-4'>
            <p className='max-w-30 md:max-w-45 pr-2 text-sm font-[Roboto] font-semibold line-clamp-3 break-words whitespace-normal '>{title}</p>
